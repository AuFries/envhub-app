...
lv_obj_t *screen_secondary_create(void)
{
    ...
    if (!style_inited)
    {
        ...
        lv_style_set_border_color(&button_panel, lv_color_hex(0x6C8794));
        ...
        lv_style_set_text_color(&title_text, lv_color_hex(0x000000));
        lv_style_set_text_font(&title_text, plex_sans_24);
    ...
    lv_obj_add_style(secondary_top_row, &panel, 0);
    ...
    lv_obj_add_style(lv_label_0, &title_text, 0);
    ...
    lv_obj_add_style(secondary_status_row, &panel, 0);
    ...
    lv_obj_add_style(lv_label_1, &small_text, 0);
    ...
    lv_obj_set_align(presence_value, LV_ALIGN_LEFT_MID);
    lv_obj_set_x(presence_value, 10);
    lv_obj_set_y(presence_value, 10);
    lv_obj_add_style(presence_value, &value_text, 0);
    ...
    lv_obj_set_x(uptime_value, -10);
    lv_obj_set_y(uptime_value, 10);
    lv_obj_add_style(uptime_value, &value_text, 0);
    ...
    lv_obj_add_style(secondary_power_wrap, &panel, 0);
    lv_obj_t *tile_batt_voltage = lv_obj_create(secondary_power_wrap);
    lv_obj_set_name(tile_batt_voltage, "tile_batt_voltage");
    lv_obj_set_width(tile_batt_voltage, 104);
    lv_obj_set_height(tile_batt_voltage, 42);
    lv_obj_set_align(tile_batt_voltage, LV_ALIGN_TOP_LEFT);
    lv_obj_set_x(tile_batt_voltage, 8);
    lv_obj_set_y(tile_batt_voltage, 8);
    lv_obj_add_style(tile_batt_voltage, &panel, 0);
    ...
    lv_label_set_text(battery_voltage_value, "0.00 V");
    lv_obj_set_align(battery_voltage_value, LV_ALIGN_BOTTOM_MID);
    lv_obj_set_y(battery_voltage_value, -2);
    ...
    lv_obj_set_width(tile_system_current, 104);
    lv_obj_set_height(tile_system_current, 42);
    lv_obj_set_align(tile_system_current, LV_ALIGN_TOP_RIGHT);
    lv_obj_set_x(tile_system_current, -8);
    lv_obj_set_y(tile_system_current, 8);
    lv_obj_add_style(tile_system_current, &panel, 0);
    lv_obj_t *lv_label_4 = lv_label_create(tile_system_current);
    lv_label_set_text(lv_label_4, "System I");
    ...
    lv_label_set_text(system_current_value, "0 mA");
    lv_obj_set_align(system_current_value, LV_ALIGN_BOTTOM_MID);
    lv_obj_set_y(system_current_value, -2);
    ...
    lv_obj_set_width(tile_system_power, 104);
    lv_obj_set_height(tile_system_power, 42);
    lv_obj_set_align(tile_system_power, LV_ALIGN_BOTTOM_LEFT);
    lv_obj_set_x(tile_system_power, 8);
    lv_obj_set_y(tile_system_power, -8);
    lv_obj_add_style(tile_system_power, &panel, 0);
    lv_obj_t *lv_label_5 = lv_label_create(tile_system_power);
    lv_label_set_text(lv_label_5, "System P");
    lv_obj_set_align(lv_label_5, LV_ALIGN_TOP_LEFT);
    lv_obj_set_x(lv_label_5, 6);
    lv_obj_set_y(lv_label_5, 2);
    ...
    lv_label_set_text(system_power_value, "0.00 W");
    lv_obj_set_align(system_power_value, LV_ALIGN_BOTTOM_MID);
    lv_obj_set_y(system_power_value, -2);
    ...
    lv_obj_set_width(tile_sensor_reads, 104);
    lv_obj_set_height(tile_sensor_reads, 42);
    lv_obj_set_align(tile_sensor_reads, LV_ALIGN_BOTTOM_RIGHT);
    lv_obj_set_x(tile_sensor_reads, -8);
    lv_obj_set_y(tile_sensor_reads, -8);
    lv_obj_add_style(tile_sensor_reads, &panel, 0);
    ...
    lv_obj_set_align(sensor_reads_value, LV_ALIGN_BOTTOM_MID);
    lv_obj_set_y(sensor_reads_value, -2);
    ...
    lv_obj_set_height(secondary_stats_panel, 102);
    ...
    lv_obj_add_style(secondary_stats_panel, &panel, 0);
    lv_obj_t *lv_label_7 = lv_label_create(secondary_stats_panel);
    lv_label_set_text(lv_label_7, "Peripherals");
    ...
    lv_label_set_text(peripheral_current_value, "0 mA");
    lv_obj_set_align(peripheral_current_value, LV_ALIGN_TOP_LEFT);
    lv_obj_set_x(peripheral_current_value, 10);
    lv_obj_set_y(peripheral_current_value, 24);
    lv_obj_add_style(peripheral_current_value, &label_text, 0);

    lv_obj_t *lv_label_8 = lv_label_create(secondary_stats_panel);
    lv_label_set_text(lv_label_8, "Compute");
    lv_obj_set_align(lv_label_8, LV_ALIGN_TOP_LEFT);
    lv_obj_set_x(lv_label_8, 10);
    lv_obj_set_y(lv_label_8, 46);
    ...
    lv_label_set_text(compute_current_value, "0 mA");
    lv_obj_set_align(compute_current_value, LV_ALIGN_TOP_LEFT);
    lv_obj_set_x(compute_current_value, 10);
    lv_obj_set_y(compute_current_value, 62);
    lv_obj_add_style(compute_current_value, &label_text, 0);
    ...
    lv_obj_set_x(lv_label_9, -72);
    lv_obj_set_y(lv_label_9, 8);
    ...
    lv_obj_set_align(cpu_util_value, LV_ALIGN_TOP_RIGHT);
    lv_obj_set_x(cpu_util_value, -10);
    lv_obj_set_y(cpu_util_value, 24);
    lv_obj_add_style(cpu_util_value, &label_text, 0);
    ...
    lv_obj_set_align(memory_util_value, LV_ALIGN_TOP_RIGHT);
    lv_obj_set_x(memory_util_value, -10);
    lv_obj_set_y(memory_util_value, 62);
    lv_obj_add_style(memory_util_value, &label_text, 0);
