...
lv_obj_t * screen_main_create(void)
{
    ...
    lv_obj_t * lv_label_2 = lv_label_create(tile_humidity);
    lv_label_set_text(lv_label_2, "Humidity (%)");
    ...
    lv_obj_t * lv_label_3 = lv_label_create(tile_co2);
    lv_label_set_text(lv_label_3, "CO2 (ppm)");
    ...
    lv_label_set_text(lv_label_8, "TVOC (ppb)");
    ...
    lv_obj_t * lv_label_9 = lv_label_create(tile_tvoc);
    lv_label_set_text(lv_label_9, "0");
    lv_obj_set_align(lv_label_9, LV_ALIGN_CENTER);
    lv_obj_set_x(lv_label_9, 0);
    lv_obj_set_y(lv_label_9, 5);
    lv_obj_add_style(lv_label_9, &value_text, 0);
    ...
    lv_label_set_text(lv_label_10, "Status: {status message}");
    lv_obj_set_align(lv_label_10, LV_ALIGN_LEFT_MID);
    lv_obj_set_x(lv_label_10, 6);
    lv_obj_add_style(lv_label_10, &label_text, 0);
